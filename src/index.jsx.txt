...
// ─── Config ───────────────────────────────────────────────────────────────────
const PAIRS = [
  { symbol: "BTCINR",  label: "BTC",     full: "Bitcoin",  dcxPair: "B-BTC_INR",  candlePair: "B-BTC_INR", color: "#f7931a", bg: "#fff8f0", icon: "₿" },
  { symbol: "ETHINR",  label: "ETH",     full: "Ethereum", dcxPair: "B-ETH_INR",  candlePair: "B-ETH_INR", color: "#627eea", bg: "#f0f2ff", icon: "Ξ" },
  { symbol: "SOLINR",  label: "SOL",     full: "Solana",   dcxPair: "B-SOL_INR",  candlePair: "B-SOL_INR", color: "#9945ff", bg: "#f8f0ff", icon: "◎" },
];
